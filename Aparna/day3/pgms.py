...
# iterating data
for data in new:
    emergency={"emergency":[{"wo_id":data["wo_id"],"work_order_date":data["work_order_date"],"work_order_details":data["work_order_details"]}]}
    general={"general":[{"wo_id":data["wo_id"],"work_order_date":data["work_order_date"],"work_order_details":data["work_order_details"]}]}
print(emergency)
print(general)
