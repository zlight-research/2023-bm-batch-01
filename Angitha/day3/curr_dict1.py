"""If I need to get all the service_ids in a list ['0x24e70', '0x24e72']"""
...
ser=[service['service_id'] for service in current_dictionary['fulfillment']['services']]
"""We take the service_id only"""
print(ser)