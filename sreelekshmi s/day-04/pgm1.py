...
f=open("D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\day-04.txt","w")
...
with open("D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\day-04.txt","r")as file:
    data=file.read()                                    #the read data can store in data  
    data=data.replace('day4' ,'4th day')                #replace the word day4 to 4th day
with open("D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\day-04.txt","w")as file:
     file.write(data)
...
f=open("D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\day-04.txt","a")
...
import os
old_name="D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\day-04.txt"
new_name="D:\\zlight\\2023-bm-batch-01-1\\sreelekshmi s\\day-04\\\\sting.txt"
